...
public class Controller {
	...
	@PostMapping("/login")
	public ResponseEntity<?> Login(@Valid @RequestParam("USERNAME") String USERNAME, @RequestParam("PWD") String PWD) {
		...
		try {
			...
			if (myUser != null) {
				...
				response.put("Mensaje", "Usuario Logeado");
				response.put("Usuario", myUser);
				status = HttpStatus.OK;
			} else {
				response.put("Error", "Contraseñas incorrectas");
